...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"Malawi Test Catalog - A comprehensive catalog of laboratory tests, diagnostics, and screening services"},{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"}],"link":[{"rel":"icon","type":"image/png","href":"/Coat_of_arms_of_Malawi.svg.png"}],"style":[],"script":[],"noscript":[],"title":"Malawi Test Catalog"};
